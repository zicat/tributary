...
public class SourceThread extends Thread {
    ...
    public SourceThread(LogQueue logQueue, int partition, long dataSize, int recordMaxLength) {
        this(logQueue, partition, dataSize, recordMaxLength, false);
    }
    ...
    public void run() {
        ...
        for (int id = 0; id < dataSize; id++) {
            try {
                ...
                logQueue.append(partition, data, 0, length);
                writeLength += length;
