...
public class LogSegmentUtil {
     ...
     * @return LogSegment.
     */
    public static LogSegment max(LogSegment s1, LogSegment s2) {
        if (s1 == null) {
            return s2;
        }
        if (s2 == null) {
     ...
     * @return LogSegment
     */
    public static LogSegment min(LogSegment s1, LogSegment s2) {
        final LogSegment max = max(s1, s2);
        return max == s1 ? s2 : s1;
    }
}
