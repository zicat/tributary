...
public class SaslHandshakeRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
            new Schema(
                    new Field(
                            "mechanism", Type.STRING, "The SASL mechanism chosen by the client."));
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mechanism == null) {
            return other.mechanism == null;
        } else {
            return this.mechanism.equals(other.mechanism);
        }
    }
