...
public class SaslHandshakeResponseData implements ApiMessage {
            ...
            if (arrayLength < 0) {
                ...
                for (int i = 0; i < arrayLength; i++) {
                    ...
                    if (length < 0) {
                        ...
                        throw new RuntimeException(
                                "string field mechanisms element had invalid length " + length);
                    } else {
        ...
        _size += 2;
        {
            ...
            for (String mechanismsElement : mechanisms) {
                ...
                if (_stringBytes.length > 0x7fff) {
                    throw new RuntimeException(
                            "'mechanismsElement' field is too long to be serialized");
                }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mechanisms == null) {
            return other.mechanisms == null;
        } else {
            return this.mechanisms.equals(other.mechanisms);
        }
    }
    ...
    public String toString() {
        return "SaslHandshakeResponseData("
                ...
                + errorCode
                + ", mechanisms="
                + MessageUtil.deepToString(mechanisms.iterator())
                + ")";
    }
