...
/** BeatsPipelineInitializationFactory. */
public class BeatsPipelineInitializationFactory implements PipelineInitializationFactory {

    public static final String IDENTITY = "beatsDecoder";

    @Override
    public PipelineInitialization createPipelineInitialization(DefaultNettySource source)
            throws Exception {
        return new BeatsPipelineInitialization(source);
    }
