...
package org.zicat.tributary.source.beats.test;
...
import static org.zicat.tributary.source.beats.BeatsPipelineInitialization.*;
...
import org.zicat.tributary.source.beats.BeatsPipelineInitialization;
import org.zicat.tributary.source.beats.BeatsPipelineInitializationFactory;
...
/** BeatsPipelineInitializationFactoryTest. */
public class BeatsPipelineInitializationFactoryTest {
    ...
    private BeatsPipelineInitialization beatsPipelineInitialization(DefaultNettySource source)
            throws Exception {
        return (BeatsPipelineInitialization)
                SpiFactory.findFactory(
                                BeatsPipelineInitializationFactory.IDENTITY,
    ...
    public void testSSL() throws Exception {
        ...
        try (final Channel channel = memoryChannelFactory("g1").createChannel(topic, config);
            ...
            final BeatsPipelineInitialization pipelineInitialization =
