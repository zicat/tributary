...
public interface Message {
     ...
     * @throws {@see org.apache.kafka.common.errors.UnsupportedVersionException} If the specified
     *     version is too new to be supported by this software.
     */
    ...
    /**
     * Reads this message from the given Readable. This will overwrite all relevant fields with
     * information from the byte buffer.
     *
    ...
    /**
     * Reads this message from the a Struct object. This will overwrite all relevant fields with
