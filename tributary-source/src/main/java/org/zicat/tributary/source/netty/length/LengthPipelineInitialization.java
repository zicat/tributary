...
package org.zicat.tributary.source.netty.length;
...
public class LengthPipelineInitialization extends ChannelPipelineInitialization {
    ...
    public void init(ChannelPipeline pipeline) {
        ...
        pipeline.addLast(createLengthChannelHandler());
    }
}
