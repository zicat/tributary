...
public class RequestHeader implements AbstractRequestResponse {
    ...
    public RequestHeader(
            ApiKeys requestApiKey, short requestVersion, String clientId, int correlationId) {
        this(
    ...
    public ResponseHeader toResponseHeader() {
        return new ResponseHeader(
                data.correlationId(), apiKey().responseHeaderVersion(apiVersion()));
    }
    ...
    public static RequestHeader parse(ByteBuffer buffer) {
        ...
        try {
            ...
            return new RequestHeader(
                    new RequestHeaderData(new ByteBufferAccessor(buffer), headerVersion),
                    headerVersion);
