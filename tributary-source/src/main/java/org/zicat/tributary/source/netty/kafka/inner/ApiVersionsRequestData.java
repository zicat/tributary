...
public class ApiVersionsRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_3 =
            new Schema(
                    new Field(
                            "client_software_name", Type.COMPACT_STRING, "The name of the client."),
                    new Field(
        ...
        if (_version >= 3) {
            {
                ...
                if (_stringBytes.length > 0x7fff) {
                    throw new RuntimeException(
                            "'clientSoftwareName' field is too long to be serialized");
                }
        ...
        if (_version >= 3) {
            {
                ...
                if (_stringBytes.length > 0x7fff) {
                    throw new RuntimeException(
                            "'clientSoftwareVersion' field is too long to be serialized");
                }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.clientSoftwareName == null) {
            if (other.clientSoftwareName != null) {
                return false;
            }
        } else {
            if (!this.clientSoftwareName.equals(other.clientSoftwareName)) {
                return false;
            }
        }
        if (this.clientSoftwareVersion == null) {
            return other.clientSoftwareVersion == null;
        } else {
            return this.clientSoftwareVersion.equals(other.clientSoftwareVersion);
        }
    }
    ...
    public int hashCode() {
        ...
        hashCode =
                31 * hashCode
                        + (clientSoftwareVersion == null ? 0 : clientSoftwareVersion.hashCode());
        return hashCode;
    }
    ...
    public String toString() {
        return "ApiVersionsRequestData("
                + "clientSoftwareName="
                + ((clientSoftwareName == null) ? "null" : "'" + clientSoftwareName + "'")
                + ", clientSoftwareVersion="
                + ((clientSoftwareVersion == null) ? "null" : "'" + clientSoftwareVersion + "'")
                + ")";
    }
