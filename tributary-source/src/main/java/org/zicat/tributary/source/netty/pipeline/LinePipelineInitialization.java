...
import org.zicat.tributary.source.netty.handler.BytesChannelHandler.MuteBytesChannelHandler;
import org.zicat.tributary.source.netty.handler.IdleCloseHandler;
import org.zicat.tributary.source.netty.handler.LineDecoder;
...
public class LinePipelineInitialization extends AbstractPipelineInitialization {
    ...
    public void init(ChannelPipeline pipeline) {
        ...
        pipeline.addLast(new MuteBytesChannelHandler(source, selectPartition()));
    }
}
