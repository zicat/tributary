...
public class MetadataResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
            new Schema(
                    new Field(
                            "brokers",
                            new ArrayOf(MetadataResponseBroker.SCHEMA_0),
                            "Each broker in the response."),
                    new Field(
                            "topics",
                            new ArrayOf(MetadataResponseTopic.SCHEMA_0),
    ...
    public static final Schema SCHEMA_1 =
            new Schema(
                    new Field(
                            "brokers",
                            new ArrayOf(MetadataResponseBroker.SCHEMA_1),
                            "Each broker in the response."),
                    new Field("controller_id", Type.INT32, "The ID of the controller broker."),
                    new Field(
                            "topics",
                            new ArrayOf(MetadataResponseTopic.SCHEMA_1),
                            "Each topic in the response."));
    ...
    public static final Schema SCHEMA_5 =
            new Schema(
                    ...
                    new Field(
                            "topics",
                            new ArrayOf(MetadataResponseTopic.SCHEMA_5),
                            "Each topic in the response."));
    ...
    public static final Schema SCHEMA_7 =
            new Schema(
                    ...
                    new Field(
                            "topics",
                            new ArrayOf(MetadataResponseTopic.SCHEMA_7),
                            "Each topic in the response."));
    ...
    public static final Schema SCHEMA_8 =
            new Schema(
                    ...
                    new Field(
                            "topics",
                            new ArrayOf(MetadataResponseTopic.SCHEMA_8),
                            "Each topic in the response."),
                    new Field(
    ...
    public static final Schema SCHEMA_9 =
            new Schema(
                    ...
                    new Field(
                            "brokers",
                            new CompactArrayOf(MetadataResponseBroker.SCHEMA_9),
                            "Each broker in the response."),
                    new Field(
                            "cluster_id",
                    ...
                    new Field(
                            "topics",
                            new CompactArrayOf(MetadataResponseTopic.SCHEMA_9),
                            "Each topic in the response."),
                    new Field(
                            "cluster_authorized_operations",
                            Type.INT32,
    ...
    public static final Schema[] SCHEMAS =
            new Schema[] {
                SCHEMA_0, SCHEMA_1, SCHEMA_2, SCHEMA_3, SCHEMA_4, SCHEMA_5, SCHEMA_6, SCHEMA_7,
                SCHEMA_8, SCHEMA_9
            };
    ...
    public void read(Readable _readable, short _version) {
        ...
        }
        {
            if (_version >= 9) {
                ...
                if (arrayLength < 0) {
                    ...
                    MetadataResponseBrokerCollection newCollection =
                            new MetadataResponseBrokerCollection(arrayLength);
        ...
        }
        {
            if (_version >= 9) {
                ...
                if (arrayLength < 0) {
                    ...
                    MetadataResponseTopicCollection newCollection =
                            new MetadataResponseTopicCollection(arrayLength);
                    for (int i = 0; i < arrayLength; i++) {
        ...
        if (_version >= 9) {
            ...
            for (int _i = 0; _i < _numTaggedFields; _i++) {
                ...
                switch (_tag) {
                    default:
                        this._unknownTaggedFields =
                                _readable.readUnknownTaggedField(
                                        this._unknownTaggedFields, _tag, _size);
                        break;
                }
            }
        }
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        if (_version >= 8) {
            ...
            if (clusterAuthorizedOperations != -2147483648) {
                throw new UnsupportedVersionException(
                        "Attempted to write a non-default clusterAuthorizedOperations at version "
                                + _version);
            }
        }
        ...
        if (_version >= 9) {
            ...
            if (_numTaggedFields > 0) {
                throw new UnsupportedVersionException(
                        "Tagged fields were set, but version "
                                + _version
                                + " of this message does not support them.");
            }
        }
    }
        ...
        if (_version >= 2) {
            if (clusterId == null) {
                ...
                if (_version >= 9) {
                    _size +=
                            _stringBytes.length
                                    + ByteUtils.sizeOfUnsignedVarint(_stringBytes.length + 1);
                } else {
    ...
    public String toString() {
        return "MetadataResponseData("
                ...
                + throttleTimeMs
                + ", brokers="
                + MessageUtil.deepToString(brokers.iterator())
                + ", clusterId="
                + ((clusterId == null) ? "null" : "'" + clusterId.toString() + "'")
                + ", controllerId="
                + controllerId
                + ", topics="
                + MessageUtil.deepToString(topics.iterator())
    ...
    public static class MetadataResponseBroker
            implements Message, ImplicitLinkedHashMultiCollection.Element {
        private int nodeId;
        private String host;
        private int port;
        private String rack;
        ...
        public void read(Readable _readable, short _version) {
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't read version " + _version + " of MetadataResponseBroker");
            }
        ...
        public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't write version " + _version + " of MetadataResponseBroker");
            }
            int _numTaggedFields = 0;
        ...
        public int size(ObjectSerializationCache _cache, short _version) {
            ...
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't size version " + _version + " of MetadataResponseBroker");
            }
            _size += 4;
            {
    ...
    public static class MetadataResponseTopic
        ...
        public static final Schema SCHEMA_0 =
                new Schema(
                        ...
                        new Field(
                                "partitions",
                                new ArrayOf(MetadataResponsePartition.SCHEMA_0),
        ...
        public static final Schema SCHEMA_5 =
                new Schema(
                        ...
                        new Field(
                                "partitions",
                                new ArrayOf(MetadataResponsePartition.SCHEMA_5),
                                "Each partition in the topic."));
        ...
        public static final Schema SCHEMA_7 =
                new Schema(
                        ...
                        new Field(
                                "partitions",
                                new ArrayOf(MetadataResponsePartition.SCHEMA_7),
                                "Each partition in the topic."));
        ...
        public static final Schema SCHEMA_9 =
                new Schema(
                        ...
                        new Field(
                                "partitions",
                                new CompactArrayOf(MetadataResponsePartition.SCHEMA_9),
                                "Each partition in the topic."),
                        new Field(
                                "topic_authorized_operations",
                                Type.INT32,
        ...
        public void read(Readable _readable, short _version) {
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't read version " + _version + " of MetadataResponseTopic");
            }
                ...
                if (_version >= 9) {
                    ...
                    if (arrayLength < 0) {
                        ...
                        ArrayList<MetadataResponsePartition> newCollection =
                                new ArrayList<MetadataResponsePartition>(arrayLength);
                        for (int i = 0; i < arrayLength; i++) {
        ...
        public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't write version " + _version + " of MetadataResponseTopic");
            }
            int _numTaggedFields = 0;
            ...
            if (_version >= 8) {
                ...
                if (topicAuthorizedOperations != -2147483648) {
                    throw new UnsupportedVersionException(
                            "Attempted to write a non-default topicAuthorizedOperations at version "
                                    + _version);
                }
            }
            RawTaggedFieldWriter _rawWriter = RawTaggedFieldWriter.forFields(_unknownTaggedFields);
        ...
        public void fromStruct(Struct struct, short _version) {
            ...
            }
            {
                ...
                for (Object nestedObject : _nestedObjects) {
                    this.partitions.add(
                            new MetadataResponsePartition((Struct) nestedObject, _version));
                }
            }
            if (_version >= 8) {
        ...
        public int size(ObjectSerializationCache _cache, short _version) {
            ...
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't size version " + _version + " of MetadataResponseTopic");
            }
            _size += 2;
            {
        ...
        public String toString() {
            return "MetadataResponseTopic("
                    ...
                    + ", partitions="
                    + MessageUtil.deepToString(partitions.iterator())
    ...
    public static class MetadataResponsePartition implements Message {
        ...
        public static final Schema SCHEMA_7 =
                new Schema(
                        ...
                        new Field("leader_id", Type.INT32, "The ID of the leader broker."),
                        new Field(
                                "leader_epoch", Type.INT32, "The leader epoch of this partition."),
                        new Field(
                                "replica_nodes",
                                new ArrayOf(Type.INT32),
                                "The set of all nodes that host this partition."),
        ...
        public void read(Readable _readable, short _version) {
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't read version " + _version + " of MetadataResponsePartition");
            }
            this.errorCode = _readable.readShort();
        ...
        public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't write version " + _version + " of MetadataResponsePartition");
            }
            int _numTaggedFields = 0;
            _writable.writeShort(errorCode);
        ...
        public int size(ObjectSerializationCache _cache, short _version) {
            ...
            if (_version > 9) {
                throw new UnsupportedVersionException(
                        "Can't size version " + _version + " of MetadataResponsePartition");
            }
            _size += 2;
            _size += 4;
            _size += 4;
        ...
        public String toString() {
            return "MetadataResponsePartition("
                    ...
                    + leaderEpoch
                    + ", replicaNodes="
                    + MessageUtil.deepToString(replicaNodes.iterator())
                    + ", isrNodes="
                    + MessageUtil.deepToString(isrNodes.iterator())
                    + ", offlineReplicas="
                    + MessageUtil.deepToString(offlineReplicas.iterator())
                    + ")";
        }
