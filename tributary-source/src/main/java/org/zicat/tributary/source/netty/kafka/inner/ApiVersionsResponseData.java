...
public class ApiVersionsResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
            new Schema(
                    ...
                    new Field(
                            "api_keys",
                            new ArrayOf(ApiVersionsResponseKey.SCHEMA_0),
    ...
    public static final Schema SCHEMA_3 =
            new Schema(
                    ...
                    new Field(
                            "api_keys",
                            new CompactArrayOf(ApiVersionsResponseKey.SCHEMA_3),
                            "The APIs supported by the broker."),
                    new Field(
                            "throttle_time_ms",
                            Type.INT32,
            ...
            if (_version >= 3) {
                ...
                if (arrayLength < 0) {
                    ...
                    ApiVersionsResponseKeyCollection newCollection =
                            new ApiVersionsResponseKeyCollection(arrayLength);
    ...
    public String toString() {
        return "ApiVersionsResponseData("
                ...
                + errorCode
                + ", apiKeys="
                + MessageUtil.deepToString(apiKeys.iterator())
                + ", throttleTimeMs="
                + throttleTimeMs
                + ")";
    }
    ...
    public static class ApiVersionsResponseKey
        ...
        public static final Schema[] SCHEMAS =
                new Schema[] {SCHEMA_0, SCHEMA_1, SCHEMA_2, SCHEMA_3};
        ...
        public void read(Readable _readable, short _version) {
            if (_version > 3) {
                throw new UnsupportedVersionException(
                        "Can't read version " + _version + " of ApiVersionsResponseKey");
            }
        ...
        public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
            if (_version > 3) {
                throw new UnsupportedVersionException(
                        "Can't write version " + _version + " of ApiVersionsResponseKey");
            }
            int _numTaggedFields = 0;
        ...
        public int size(ObjectSerializationCache _cache, short _version) {
            ...
            if (_version > 3) {
                throw new UnsupportedVersionException(
                        "Can't size version " + _version + " of ApiVersionsResponseKey");
            }
            _size += 2;
            _size += 2;
            _size += 2;
