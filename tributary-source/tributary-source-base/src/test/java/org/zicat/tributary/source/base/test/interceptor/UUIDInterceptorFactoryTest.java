...
public class UUIDInterceptorFactoryTest {
    ...
    public void testDefaultKey() {
        ...
        Assert.assertNull(records.headers().get(RecordsUtils.HEADER_KEY_UUID));
        final Records result = interceptor.intercept(records);
        Assert.assertNotNull(result);
        final byte[] uuidBytes = result.headers().get(RecordsUtils.HEADER_KEY_UUID);
    ...
    public void testConcatOnMultipleIntercept() {
        ...
        final String value =
                new String(
                        records.headers().get(RecordsUtils.HEADER_KEY_UUID),
