...
public class EventExecutorGroups {
     ...
     */
    public static EventExecutorGroup createEventExecutorGroup(String name, int threads) {
        LOG.info("Create EventExecutorGroup, name: {}, threads: {}", name, threads);
        return threads <= 0
                ? null
                : new DefaultEventExecutorGroup(threads, createThreadFactoryByName(name, true));
    }
}
