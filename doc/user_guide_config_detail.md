...
| interceptors               | timestamp | array<string> | the interceptor identity list split by `,`, default timestamp append head key `_rec_ts` and value `string(System.currentTimeMillis)` in records                                                                                                                                                                                                                                                          |
...
2. HbaseSink
   require [Record0](../tributary-common/src/main/java/org/zicat/tributary/common/records/Record0.java) has key.
