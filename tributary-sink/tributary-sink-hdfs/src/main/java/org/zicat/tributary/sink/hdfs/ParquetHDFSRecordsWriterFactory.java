...
public class ParquetHDFSRecordsWriterFactory implements HDFSRecordsWriterFactory {
    ...
    public String fileExtension(Context context) {
        return compressionCodecName(context).getExtension() + ".parquet";
    }

    /**
     * get codec name from context.
     *
     * @param context context
     * @return CompressionCodecName
     */
    private static CompressionCodecName compressionCodecName(Context context) {
        return CompressionCodecName.fromConf(context.get(OPTION_OUTPUT_COMPRESSION_CODEC));
    }
}
