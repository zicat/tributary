...
/** LineSourceFileChannelPrintSinkApplication. */
public class LineSourceFileChannelPrintSinkApplication {

    private static final String ACTIVE_PROFILE = "line-source-file-channel-print-sink";
