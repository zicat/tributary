...
/** BeatsSourcePrintSinkApplication. */
public class LogstashBeatsSslSourcePrintSinkApplication {

    private static final String ACTIVE_PROFILE = "logstash-beats-ssl-source-print-sink";
